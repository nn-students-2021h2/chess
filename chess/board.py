...
from chess.pieces import Piece, PieceType, PieceFactory
from chess.structs import ChessPosition, MoveCommand
...
class ChessBoard:
    ...
    def spot_search_threat(self, start_position: ChessPosition, own_color, increment_x: int, increment_y: int, threat_only = False, free_only = False):
